        ...
        <div class="row">
            ...
            <form method="post" class="mx-auto" enctype="multipart/form-data">
                ...
                <table class="table-sm table-dark"><h4 class="display-5">
                        Add New Game Information</h4>

                    <tr>
                        <td>Game ID</td>
                        <td><input type="text" class="form-control text-center" name="add_new_gameID" value="<?php echo addslashes($_POST['add_new_gameID']); ?>"/></td>
                    </tr>
                    <tr>
                        <td>Game Name</td>
                        <td><input type="text" class="form-control text-center" name="add_new_game_name" value="<?php echo addslashes($_POST['add_new_game_name']); ?>"/></td>
                    </tr>
                    <tr>
                        <td>Number of Players</td>
                        <td><input type="text" class="form-control text-center" name="add_new_game_num_of_player" value="<?php echo addslashes($_POST['add_new_game_num_of_player']); ?>"/></td>
                    </tr>
                    <tr>
                        <td>Game Rating</td>
                        <td><input type="text" class="form-control text-center" name="add_new_game_rating" value="<?php echo addslashes($_POST['add_new_game_rating']); ?>"/></td>
                    </tr>
                    <tr>
                        <td>Game Description</td>
                        <td><textarea type="text" class="form-control text-left" cols="70" rows="10" name="add_new_game_description"><?php echo addslashes($_POST['add_new_game_description']); ?></textarea></td>
                    </tr>
                    <tr>
                        <td>Game Image</td>
                ...
                <input class="btn btn-warning my-2 my-sm-0\" type="submit" name="submit" value="Add New Game"/>
